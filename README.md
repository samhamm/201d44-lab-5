...
### First Part: Writing Code On Branches
...
### Second Part: Finish and Deploy "About Me"
...
* Place no new function calls in your code, unless inside of another function. Everything should be tested by hand from the console. This is to give you additional practice using the console and practice efficient app-switching processes.
